...
def main():
    ...
    if select_type == 'crop prediction':
        st.sidebar.title("Select One")
        select_type = st.sidebar.radio("", ('Data Info','visualize crop', 'Predict Your Crop'))
        ...
        st.sidebar.title("Select One")
        select_type = st.sidebar.radio("", ('Data Info','visualize soil columns', 'Predict Your soil'))
